...
<head>
	...
	<title>Login</title>
	<link rel="stylesheet" href="<%=path%>/vedio/dist/jquery.vidbacking.css" type="text/css">
	<base href="<%=basePath%>">
...
<body>
	<div class="">
		<video poster="<%=path%>/vedio/assets/screenshot1.jpg" autoplay muted loop class="vidbacking">
		        <source src="<%=path%>/vedio/assets/Magazine.mp4" type="video/mp4">
		</video>
		<div class="video-back" >
		 	<div class="form" stylle="position:absolute; top:10%; left:20%;right:20%;">
...
function check() {
	...
	<script src="<%=path%>/vedio/dist/jquery.vidbacking.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(function(){
            $('body').vidbacking({
                'masked': true
